...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://example.com/status%C2%85hidden",
        "https://example.com/status%E2%80%8Bhidden",
        "https://example.com/status%E2%80%AEevil.test",
        "https://example.com/status%FFinvalid",
