...
- Fail-closed remediation plan at `/api/remediation-plan`, routing missing, stale, invalid, and future-dated snapshot evidence into a dedicated monitoring bucket instead of returning an empty operator plan.
