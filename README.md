...
- Bounded site identifiers (200-character site/client labels and 2,048-character URLs) plus 100-character WordPress version values reject accidental oversized submissions before they can inflate persistent dashboard and report data; equivalent expanded and compressed IPv6 host spellings are canonicalized to one tracked endpoint.
