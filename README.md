...
- Direct stale-evidence queues at `/api/stale-snapshots` and `/api/stale-care-checks`, distinguishing missing, stale, invalid-timestamp, and clock-skewed observations with operator repair actions and configurable freshness thresholds.
