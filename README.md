...
- Self-contained dashboard assets, a restrictive Content Security Policy, same-origin opener/resource isolation, and disabled legacy cross-domain policies avoid third-party font/CDN requests and cross-origin embedding of the internal operations UI.
